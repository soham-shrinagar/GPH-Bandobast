...
export default function LoginId() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(`${baseUrl}/api/login-id`, {
        method: "POST",
      ...
      if (res.ok) {
        ...
        localStorage.setItem("officerId", backendData.officerId);
        localStorage.setItem("officerName", backendData.officer);
      ...
      console.error("Error from frontend login:", err);
    } finally {
      setIsLoading(false);
    }
  }
